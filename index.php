...
<body id="top">
    ...
    <div class="footer">
        <p>
			<a id="footer_about" href="http://www.apphp.com/php-website-cleaner/index.php" target="_new" title="Opens in new window">ApPHP WebsiteCleaner <small>v1.1.6</small> &copy; ApPHP <?php echo @date('Y'); ?></a>               
